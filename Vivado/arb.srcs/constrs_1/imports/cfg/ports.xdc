...
set_property IOSTANDARD LVCMOS33 [get_ports {dac_rst_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dac_sel_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dac_wrt_o[0]}]
set_property SLEW FAST [get_ports dac_*_o]
set_property DRIVE 8 [get_ports dac_clk_o]
set_property DRIVE 8 [get_ports {dac_rst_o[0]}]
set_property DRIVE 8 [get_ports {dac_sel_o[0]}]
set_property DRIVE 8 [get_ports {dac_wrt_o[0]}]
