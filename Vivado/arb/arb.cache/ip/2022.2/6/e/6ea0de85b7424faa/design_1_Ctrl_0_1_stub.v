...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, bram_read, bram_addr, 
  freq_divisor_rstn, bram_reader_rstn, freq_divisor_value, num_of_samples, s)
/* synthesis syn_black_box black_box_pad_pin="clk,reset,bram_read[31:0],bram_addr[31:0],freq_divisor_rstn,bram_reader_rstn,freq_divisor_value[31:0],num_of_samples[31:0],s" */;
  input clk;
  input reset;
