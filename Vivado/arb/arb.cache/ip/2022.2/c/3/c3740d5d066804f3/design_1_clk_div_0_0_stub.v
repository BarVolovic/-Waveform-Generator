...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ref_clock, divisor, rst, out_clock)
/* synthesis syn_black_box black_box_pad_pin="ref_clock,divisor[31:0],rst,out_clock" */;
  input ref_clock;
  input [31:0]divisor;
  input rst;
  output out_clock;
